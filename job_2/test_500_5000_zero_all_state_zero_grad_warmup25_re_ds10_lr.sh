...
#SBATCH --gpus=1
#SBATCH --job-name=test_500_5000_zero_all_state_zerograd_warmup25_re_lr_ds_10
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=18

#SBATCH --time=20:00:00
#SBATCH --output=../logs_2/updatemask%A_new_500_5000_grad_max_zero_all_state_ZeroGrad_cosinedecay25_remove_lr_ds10.out
