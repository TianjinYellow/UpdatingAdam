...
#SBATCH --gpus=1
#SBATCH --job-name=test_500_5000_zero_all_state_zerograd_warmup25_re_lr_ds_50
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=18

#SBATCH --time=20:00:00
#SBATCH --output=../logs_2/updatemask%A_new_500_5000_grad_max_zero_all_state_ZeroGrad_cosinedecay50_remove_lr_ds25.out
...
#do
for i in 0.001 0.005 0.008 0.01 0.03 0.05 
do
