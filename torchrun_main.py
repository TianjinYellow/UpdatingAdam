...
def main(args):
    ...
    if 'galore' in args.optimizer.lower():
        ...
        param_groups = [{'params': regular_params,'zero_all_state':args.zero_all_state}, 
                        {'params': galore_params, 'rank': args.rank,'zero_grad':args.zero_grad,'zero_all_state':args.zero_all_state,'zero_state':args.zero_state, 'update_proj_gap': args.update_proj_gap, 'scale': args.galore_scale, 'proj_type': args.proj_type}]
    ...
    if args.optimizer.lower() == "adam":
        ...
        optimizer = GaLoreAdamW(param_groups, lr=args.lr, weight_decay=args.weight_decay,updating_mask_method=args.updating_mask_method,warmup_epoch=args.warmup_epoch)
    # implement sgd
