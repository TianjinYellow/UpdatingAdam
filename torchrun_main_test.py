...
from galore_torch import GaLoreAdamW1, GaLoreAdamW8bit, GaLoreAdafactor
...
def main(args):
    ...
    if args.optimizer.lower() == "adam":
        ...
        optimizer = GaLoreAdamW1(param_groups, lr=args.lr, weight_decay=args.weight_decay,updating_mask_method=args.updating_mask_method)
    # implement sgd
