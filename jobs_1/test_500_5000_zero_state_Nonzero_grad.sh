...
#SBATCH --gpus=1
#SBATCH --job-name=test_500_5000_zero_state_nonzerograd_wawrmup100
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=18

#SBATCH --time=20:00:00
#SBATCH --output=../logs_1/updatemask%A_new_500_5000_grad_max_zero_state_nonZeroGrad_cosinedecay100.out
