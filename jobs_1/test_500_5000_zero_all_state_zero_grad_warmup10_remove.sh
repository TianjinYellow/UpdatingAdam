...
#SBATCH --gpus=1
#SBATCH --job-name=test_500_5000_zero_all_state_zerograd_warmup10_re
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=18

#SBATCH --time=20:00:00
#SBATCH --output=../logs_1/updatemask%A_new_500_5000_grad_max_zero_all_state_ZeroGrad_cosinedecay10_remove.out
...
#do
for i in 25 50 100 200 400 500
do
