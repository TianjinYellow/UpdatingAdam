...
#SBATCH --gpus=1
#SBATCH --job-name=test_500_5000_zero_all_state_nonzerograd_search_sp50
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=18

#SBATCH --time=20:00:00
#SBATCH --output=../logs_1/updatemask%A_new_500_5000_grad_max_zero_all_state_nonZeroGrad_cosinedecay100_search_lr_wights_decay_sp50.out
...
do
for j in 0 1e-5 1e-4 5e-4 1e-3
do
