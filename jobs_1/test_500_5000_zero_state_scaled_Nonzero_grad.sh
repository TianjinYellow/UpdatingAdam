...
#SBATCH --gpus=1
#SBATCH --job-name=test_100_1000_zero_state_scaled_nonzerograd
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=18

#SBATCH --time=20:00:00
#SBATCH --output=../logs_1/updatemask%A_new_100_1000_grad_max_zero_state_Scaled_nonZeroGrad.out
