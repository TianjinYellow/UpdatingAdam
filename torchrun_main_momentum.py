...
from galore_torch import GaLoreAdamWMomemtum, GaLoreAdamW8bit, GaLoreAdafactor
...
def main(args):
    ...
    if 'galore' in args.optimizer.lower():
        ...
        param_groups = [{'params': regular_params}, 
                        {'params': galore_params, 'rank': args.rank,'zero_grad':args.zero_grad,'zero_state':args.zero_state, 'update_proj_gap': args.update_proj_gap, 'scale': args.galore_scale, 'proj_type': args.proj_type}]
    ...
    if args.optimizer.lower() == "adam":
        ...
        optimizer = GaLoreAdamWMomemtum(param_groups, lr=args.lr, weight_decay=args.weight_decay,updating_mask_method=args.updating_mask_method)
    # implement sgd
        ...
        for p in model.parameters():
            if p.requires_grad:
                if id(p) in id_galore_params:
                    optimizer_dict[p] = GaLoreAdamW8bit([{'params': [p], 'rank': args.rank,'zero_grad':args.zero_grad,'update_proj_gap': args.update_proj_gap * 2, 'scale': args.galore_scale, 'proj_type': args.proj_type}], lr=args.lr, weight_decay=args.weight_decay)
                else:
