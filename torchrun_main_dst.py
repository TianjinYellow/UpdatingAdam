...
from galore_torch import GaLoreAdamWdst, GaLoreAdamW8bit, GaLoreAdafactor
...
def main(args):
    ...
    if args.optimizer.lower() == "adam":
        ...
        optimizer = GaLoreAdamWdst(param_groups, lr=args.lr, weight_decay=args.weight_decay,updating_mask_method=args.updating_mask_method)
    # implement sgd
