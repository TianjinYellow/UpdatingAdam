...
from galore_torch import GaLoreAdamW_sampling, GaLoreAdamW8bit, GaLoreAdafactor
...
def parse_args(args):
    ...
    parser.add_argument("--save_dir", type=str, default="/scratch-shared/HTJ/")
...
def main(args):
    ...
    if args.optimizer.lower() == "adam":
        ...
        optimizer = GaLoreAdamW_sampling(param_groups, lr=args.lr, weight_decay=args.weight_decay,updating_mask_method=args.updating_mask_method,warmup_epoch=args.warmup_epoch)
    # implement sgd
