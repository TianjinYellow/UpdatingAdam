...
from galore_torch import GaLoreAdamWInplace, GaLoreAdamW8bit, GaLoreAdafactor
...
def main(args):
    ...
    if args.optimizer.lower() == "adam":
        ...
        optimizer = GaLoreAdamWInplace(param_groups, lr=args.lr, weight_decay=args.weight_decay)
    # implement sgd
